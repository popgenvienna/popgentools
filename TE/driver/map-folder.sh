...
do
	...
	m3="perl /Volumes/Temp2/Robert/popoolationte/samro.pl --fq1 $infolder/${n}_1.fq.gz --fq2 $infolder/${n}_2.fq.gz --sam1 $outfolder/raw/${n}_1.sam --sam2 $outfolder/raw/${n}_2.sam --output /dev/stdout | samtools view -Sb - | samtools sort -m 4G - $outfolder/${n}.sort"
	eval $m1
	eval $m2
	eval $m3 
done
