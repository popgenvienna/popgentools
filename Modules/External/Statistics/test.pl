...
if (chisqrdistr (2,.05) == 5.9915) { print "ok 2\n"; }
else { print "not ok 2\n"; }
if (udistr (.05) == 1.6449) { print "ok 3\n"; }
else { print "not ok 3\n"; }
if (tdistr (1,.005) == 63.657) { print "ok 4\n"; }
else { print "not ok 4\n"; }
if (fdistr (1,3,.01) == 34.116) { print "ok 5\n"; }
else { print "not ok 5\n"; }
if (uprob (-.85) == .80234) { print "ok 6\n"; }
else { print "not ok 6\n"; }
if (chisqrprob (3,6.25) == .10006) { print "ok 7\n"; }
else { print "not ok 7\n"; }
if (tprob (3,6.251) == .0041301) { print "ok 8\n"; }
else { print "not ok 8\n"; }
if (fprob (6,6,.625) == 0.70879) { print "ok 9\n"; }
else { print "not ok 9\n"; }
