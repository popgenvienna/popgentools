...
def freqhash(inp,i):
	...
	if cov!=0:
		...
		return "na"
def max_allele_change(inp,comprep):
	h,h1,h2=collections.defaultdict(lambda:0),collections.defaultdict(lambda:0),collections.defaultdict(lambda:0)
	for i in comprep[0]:
		#print i
...
for line in pops:
	...
	for line1 in line.split(","):
		allpops.append(line1)
genepops=zip(*o)
#print genepops
comprep=[genepops[start],genepops[end]] #replicates at different timepoints
#print comprep
comptime=[pops[start].split(","),pops[end].split(",")] #timepoints  at different replicates
