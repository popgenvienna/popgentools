...
parser.add_option("--disable-strand",dest="disablestrand",action="store_true", help="Disable the strandedness")
...
disablestrand=bool(options.disablestrand)
tefhashloadmethod=None
if(disablestrand):
	print "Strand will not be considered"
	tefhashloadmethod=load_tefamhash_disablestrand
else:
	print "Strand will be considered"
	tefhashloadmethod=load_tefamhash_enablestrand
